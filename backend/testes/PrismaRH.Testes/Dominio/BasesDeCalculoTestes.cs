...
public class BasesDeCalculoTestes
{
    ...
    public void RubricaQueSoIncideEmFgts_NaoEntraNasOutrasDuas()
    {
        ...
        folha.AdicionarLancamentoManual(holerite.Id, Provento("PREMIO", BaseCalculo.Fgts), 500m, null);
    ...
    public void ComissaoSomaNaBase_E_ValeTransporteNaoReduz()
    {
        ...
        folha.AdicionarLancamentoManual(holerite.Id, Provento("COM", IntegraTudo), 500m, null);

        var vt = new Rubrica(
            Org, "VT", "Vale-transporte",
            TipoRubrica.Desconto, EstrategiaRubrica.ValorInformado, BaseCalculo.Nenhuma, Agora);

        folha.AdicionarLancamentoManual(holerite.Id, vt, 180m, null);
    ...
    public void RubricaInformativa_EntraNaBase_E_NaoMexeNoLiquido()
    {
        ...
        folha.AdicionarLancamentoManual(holerite.Id, Informativa("BFG", BaseCalculo.Fgts), 250m, null);
    ...
    public void RemoverLancamento_TiraOValorDaBase()
    {
        ...
        folha.RemoverLancamento(holerite.Id, lancamento.Id);
    ...
    public void EfeitoNaBase_DeDesconto_EZero()
    {
        ...
        var lancamento = folha.AdicionarLancamentoManual(holerite.Id, vt, 180m, null);
